...
mongoose.connect(`mongodb://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0-shard-00-00.ucykc.mongodb.net:27017,cluster0-shard-00-01.ucykc.mongodb.net:27017,cluster0-shard-00-02.ucykc.mongodb.net:27017/myBooks?ssl=true&replicaSet=atlas-sbsml7-shard-0&authSource=admin&retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true });
